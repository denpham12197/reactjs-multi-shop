...
function useClickOutside(ref, setState) {
  useEffect(() => {
    ...
    return (()=>{document.removeEventListener("mousedown", handClick);})
  }, [ref, setState])
}
				...
				<div className="toolbar__wrapper-toolbar--flud-center">
					<div className="top-toolbar__toolbar-pattern--left-side">
						<ul className="top-toolbar__toolbar-left--wrapper">
							<li className="toolbar__toolbar-item toolbar__toolbar-item--text">About</li>
							<li className="toolbar__toolbar-item toolbar__toolbar-item--text">Contact</li>
							<li className="toolbar__toolbar-item toolbar__toolbar-item--text">Help</li>
							<li className="toolbar__toolbar-item toolbar__toolbar-item--text">FAQs</li>
						</ul>
					</div>
					<div className="top-toolbar__toolbar-pattern--right-side">
						<ul className="toolbar__toolbar-right--wrapper">
							<li ref={refAuthor} className="toolbar__toolbar-item toolbar__toolbar-item--relative">
								<button 
                  onClick={()=>setShowAuthorOption(!showAuthorOption)}
                  className={`right-menu__button-dropdown ${showAuthorOption&& 'right-menu__button-dropdown-focus'}`}>
                  My Account
                </button>
                {
                  showAuthorOption &&
                  <div className="right-menu__dropdown-box">
                    ...
                    <div className="dropdown-item">Sign up</div>
							...
							<li ref={refMoneyUnit} className="toolbar__toolbar-item toolbar__toolbar-item--relative">
									<button
                    onClick={()=>setShowMoneyUnitOption(!showMoneyUnitOption)}
                    className={`right-menu__button-dropdown ${showMoneyUnitOption&& 'right-menu__button-dropdown-focus'}`}>USD</button>
                  {
                    showMoneyUnitOption && 
                    <div className="right-menu__dropdown-box">
                      ...
                      <div className="dropdown-item">CAD</div>
							...
							<li ref={refLanguage} className="toolbar__toolbar-item toolbar__toolbar-item--relative">
                <button 
                  onClick={()=>setShowLanguageOption(!showLanguageOption)}
                  className={`right-menu__button-dropdown ${showLanguageOption&& 'right-menu__button-dropdown-focus'}`}>
                  EN
                </button>
                { 
                  showLanguageOption && 
